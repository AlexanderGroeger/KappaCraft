items = {
    ...
    "diamond_sword": (
        ...
        {
            "cost": 25,
            "enchantments": {"sharpness": 40, "knockback": 1, "fire_aspect": 1, "looting": 1, "sweeping_edge": 1, "unbreaking": 2},
            "keep": True,
            "display": """display:{Lore:['[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
        {
            "cost": 40,
            "enchantments": {"sharpness": 65, "knockback": 2, "fire_aspect": 2, "looting": 2, "sweeping_edge": 2, "unbreaking": 3},
            "keep": True,
            "display": """display:{Lore:['[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
        {
    ...
    "netherite_sword": (
        ...
        {
            "cost": 2,
            "enchantments": {"sharpness": 20, "knockback": 1, "fire_aspect": 1,},
            "keep": 1,
            "display": """display:{Lore:['[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
        {
            "cost": 10,
            "enchantments": {"sharpness": 40, "knockback": 1, "fire_aspect": 1, "looting": 1, "unbreaking": 1},
            "keep": 1,
            "display": """display:{Lore:['[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
        {
            "cost": 25,
            "enchantments": {"sharpness": 80, "knockback": 1, "fire_aspect": 1, "looting": 1, "sweeping_edge": 1, "unbreaking": 2},
            "keep": 1,
            "display": """display:{Lore:['[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
        {
            "cost": 40,
            "enchantments": {"sharpness": 160, "knockback": 2, "fire_aspect": 2, "looting": 2, "sweeping_edge": 2, "unbreaking": 3},
            "keep": 1,
            "display": """display:{Lore:['[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
        {
