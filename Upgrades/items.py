items = {
    ...
    "diamond_sword": (
        ...
        {
            "cost": 50,
            "enchantments": {"sharpness": 100, "knockback": 2, "fire_aspect": 2, "looting": 3, "sweeping": 3},
            "unbreakable": True,
            "keep": True,
        ...
        {
            "enchantments": {"sharpness": 250, "knockback": 2, "fire_aspect": 2, "looting": 3, "sweeping": 3},
            "unbreakable": True,
            "keep": True,
    ...
    "netherite_sword": (
        ...
        {
            "cost": 25,
            "enchantments": {"sharpness": 80, "knockback": 1, "fire_aspect": 1, "looting": 1, "sweeping": 1, "unbreaking": 2},
            "keep": 1,
            "display": """display:{Lore:['[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
        {
            "cost": 40,
            "enchantments": {"sharpness": 160, "knockback": 2, "fire_aspect": 2, "looting": 2, "sweeping": 2, "unbreaking": 3},
            "keep": 1,
            "display": """display:{Lore:['[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
        {
            "cost": 50,
            "enchantments": {"sharpness": 320, "knockback": 2, "fire_aspect": 2, "looting": 3, "sweeping": 3},
            "unbreakable": True,
            "keep": True,
            "display": """display:{Lore:['[{"text":"Near-perfectly crafted","italic":false,"color":"dark_purple"}]','[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
        {
            "enchantments": {"sharpness": 1000, "knockback": 2, "fire_aspect": 2, "looting": 5, "sweeping": 3},
            "unbreakable": True,
            "keep": True,
            "display": """display:{Lore:['[{"text":"Perfectly crafted","italic":false,"color":"dark_purple"}]','[{"text":"This item will not be lost on death","italic":false,"color":"dark_purple"}]']}""",
        },
