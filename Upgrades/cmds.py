...
main = """execute at @p[nbt={SelectedItem:{id:"minecraft:___item",tag:{Enchantments:[{id:"minecraft:___enchantment",lvl:___oldLvl}]}}},nbt={Inventory:[{Slot:-106b,id:"minecraft:___item",tag:{Enchantments:[{id:"minecraft:___enchantment",lvl:___oldLvl}]}}]},scores={upgrade=1..,xpLevel=___levelsNeeded..}] run scoreboard players set @p upgrading 1"""
