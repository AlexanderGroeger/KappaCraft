...
#Negative direction
tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-4096] ~ ~-4096 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-4096] scoretp_y 4096

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-2048] ~ ~-2048 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-2048] scoretp_y 2048

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-1024] ~ ~-1024 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-1024] scoretp_y 1024

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-512] ~ ~-512 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-512] scoretp_y 512

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-256] ~ ~-256 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-256] scoretp_y 256

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-128] ~ ~-128 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-128] scoretp_y 128

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-64] ~ ~-64 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-64] scoretp_y 64

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-32] ~ ~-32 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-32] scoretp_y 32

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-16] ~ ~-16 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-16] scoretp_y 16

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-8] ~ ~-8 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-8] scoretp_y 8

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-4] ~ ~-4 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-4] scoretp_y 4

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-2] ~ ~-2 ~
scoreboard players add @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-2] scoretp_y 2

tp @e[type=area_effect_cloud,name=scoretp_y_hejgb,score_scoretp_y=-1] ~ ~-1 ~
